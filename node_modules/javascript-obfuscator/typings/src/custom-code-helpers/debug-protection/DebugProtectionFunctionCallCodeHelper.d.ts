...
export declare class DebugProtectionFunctionCallCodeHelper extends AbstractCustomCodeHelper {
    ...
    initialize(debugProtectionFunctionName: string, callsControllerFunctionName: string): void;
