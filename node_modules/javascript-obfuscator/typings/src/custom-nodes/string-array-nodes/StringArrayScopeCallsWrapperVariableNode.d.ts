...
export declare class StringArrayScopeCallsWrapperVariableNode extends AbstractStringArrayCallNode {
    ...
    initialize(stringArrayScopeCallsWrapperData: IStringArrayScopeCallsWrapperData, stringArrayCallsWrapperData: IStringArrayScopeCallsWrapperData): void;
