...
let handler = async (m, { conn }) => {
    ...
    let pp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://i.imgur.com/eAadPYL.jpg');
...
Your newfound power will strike fear into the hearts of Curses and Sorceres, and the bots will bow before your command! Keep up the incredible work, and who knows what epic adventures await you next! 🌟
`.trim();
